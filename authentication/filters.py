...
class UserFilter(filters.FilterSet):
    ...
    metro__in = filters.BaseInFilter(field_name='metro__name')
    industry__in = filters.BaseInFilter(field_name='industry__name')
    job_title__in = filters.BaseInFilter(field_name='job_title__name')
